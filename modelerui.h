...
private:
  ...
  static void cb_Fame_All(Fl_Menu_*, void*);
public:
...
public:
  ...
  void show();
private:
	Fl_Window* m_constrainedMotionWindow;
	Fl_Button* moveButton;
	Fl_Input* LeftArmXInput;
	Fl_Input* LeftArmYInput;
	Fl_Input* LeftArmZInput;
	Fl_Input* rightHandTargetX;
	Fl_Input* rightHandTargetY;
	Fl_Input* rightHandTargetZ;

	static void cb_Constrained_Motion(Fl_Menu_*, void*);
	static void cb_Execute_Constrained_Motion(Fl_Widget* o, void* v);
};
#endif
