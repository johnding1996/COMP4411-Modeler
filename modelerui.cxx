...
inline void ModelerUserInterface::cb_Frame_All_i(Fl_Menu_* o, void* v) {
	m_modelerView->m_camera->setFrameAll();
	m_modelerView->redraw();
}
void ModelerUserInterface::cb_Fame_All(Fl_Menu_* o, void* v) {
...
void ModelerUserInterface::cb_Constrained_Motion(Fl_Menu_* o, void* v) {
	((ModelerUserInterface*)(o->parent()->user_data()))->m_constrainedMotionWindow->show();
}

void ModelerUserInterface::cb_Execute_Constrained_Motion(Fl_Widget* o, void* v) {
	float rightX = atof(((ModelerUserInterface*)(o->user_data()))->rightHandTargetX->value());
	float rightY = atof(((ModelerUserInterface*)(o->user_data()))->rightHandTargetY->value());
	float rightZ = atof(((ModelerUserInterface*)(o->user_data()))->rightHandTargetZ->value());
	ConstrainedMotion cm;
	cm.moveArms(rightX, rightY, rightZ);
}
...
Fl_Menu_Item ModelerUserInterface::menu_m_controlsMenuBar[] = {
 ...
 { "Frame All", 0, (Fl_Callback*)ModelerUserInterface::cb_Fame_All, 0, 0, 0, 0, 14, 0 },
 { "Constrained Motion", 0, (Fl_Callback*)ModelerUserInterface::cb_Constrained_Motion, 0, 0, 0, 0, 14, 0 },
 {0},
 {0}
};
...
ModelerUserInterface::ModelerUserInterface() {
  ...
  m_constrainedMotionWindow = new Fl_Window(160, 150, "Constrained Motion");
  rightHandTargetX = new Fl_Input(100, 10, 50, 25, "Right Hand X");
  rightHandTargetY = new Fl_Input(100, 40, 50, 25, "Right Hand Y");
  rightHandTargetZ = new Fl_Input(100, 70, 50, 25, "Right Hand Z");

  moveButton = new Fl_Button(100, 120, 50, 25, "&Move");
  moveButton->user_data((void*)(this));
  moveButton->callback(cb_Execute_Constrained_Motion);

  m_constrainedMotionWindow->end();
}
